    ...
    <div class="content">
      ...
      <div class="item-video">
        ...
        <div class="video-box">
          ...
          <div class="video" :class="{ showSlide: showSlide }">
...
.product {
  .content {
    .item-bg {
      @include bgh("../../public/imgs/product/product-bg-1.png", 718px);
      text-align: center;
      h2 {
        font-size: $fontA;
        padding-top: 55px;
    ...
    .item-bg-2 {
      @include bgh("../../public/imgs/product/product-bg-2.png", 480px);
      background-size: 1226px 397px;
    }

    .item-bg-3 {
      @include bgh("../../public/imgs/product/product-bg-3.png", 638px);
    ...
    .item-video {
      ...
      .video-bg {
        @include bgh("../../public/imgs/product/gallery-1.png");
